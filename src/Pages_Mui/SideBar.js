...
export default function SideBar() {
  ...
  return (
    <Box sx={{ width: '100%', maxWidth: 360, backgroundColor: 'gray' }}>
      <List component="nav" aria-label="main mailbox folders" sx={{color:"black",backgroundColor:"white"}}>
                <ListItemButton
      ...
      <Divider />
      <List component="nav" aria-label="secondary mailbox folder"sx={{color:"black",backgroundColor:"white"}}>
        <ListItemButton
